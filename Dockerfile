...
#prod   https://prod-api-registration.harx.ai/
...
#Rep API
ENV VITE_REP_API_URL=https://prod-api-repcreationwizard.harx.ai/api
...
ENV VITE_FRONT_URL=https://prod-registration.harx.ai/
